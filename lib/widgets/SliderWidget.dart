...
class ACarouselSlider extends StatefulWidget {
  ACarouselSlider(
  ...
  /// The widgets to be Aown in the carousel of default constructor
  final List<Widget>? items;

  /// The widget item builder that will be used to build item on demand
  final IndexedWidgetBuilder? itemBuilder;

  /// The widgets count that Aould be Aown at carousel
  final int itemCount;
  ...
  /// The fraction of the viewport that each page Aould occupy.
  ///
  /// Defaults to 0.8, which means each page fills 80% of the carousel.
  final num viewportFraction;

  /// The initial page to Aow when first creating the [ACarouselSlider].
  ///
  /// Defaults to 0.
  ...
  ///Determines if carousel Aould loop infinitely or be limited to item length.
  ///
  ...
  /// Determines if current page Aould be larger then the side images,
  ...
  /// How the carousel Aould respond to user input.
  ///
  ...
  /// Animates the controlled [ACarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [ACarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [ACarouselSlider].
  ///
  ...
  /// Animates the controlled [ACarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _ACarouselSliderState createState() => _ACarouselSliderState();
}

class _ACarouselSliderState extends State<ACarouselSlider>
