                    ...
                    Container(
                      ...
                      child: Icon(
                        ...
                        color: Colors.grey,
                          ...
                          width: constraints.maxWidth * 0.8, //width for progress bar
                          animation: true, //animation to show progress at first
                          animationDuration: 1000,
                          lineHeight: 12.0,
                          percent: 0.3, // 30/100 = 0.3
                          center: Text(getLeftProduct(item.inStock, item.ordered),style: TextStyle(fontSize: 10,
                          fontWeight: FontWeight.bold,
                          color: Colors.black,)),
                          linearStrokeCap: LinearStrokeCap.roundAll, //make round cap at start and end both
                          progressColor: Colors.red[300], //percentage progress bar color
                          backgroundColor: Colors.black12,  //background progressbar color
                        ),
                ]))])],
            );
          },
