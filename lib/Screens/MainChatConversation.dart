...
class MainChatConversationScreen extends StatefulWidget {
  ...
  static String tag = '/MainChatConversationScreen';

  @override
  _MainChatConversationScreenState createState() => _MainChatConversationScreenState();
}

class _MainChatConversationScreenState extends State<MainChatConversationScreen> {
  ScrollController scrollController = ScrollController();
  TextEditingController msgController = TextEditingController();
  FocusNode msgFocusNode = FocusNode();

  List<MessageModel> msgListing = [];
  ...
  init() async {
    msgListing = AppData().getChatMsgData();
