...
class DeliverSingUpScreen extends StatefulWidget {
  static String tag = '/DeliverSingUpScreen';

  @override
  DeliverSingUpScreennState createState() => DeliverSingUpScreennState();
}

class DeliverSingUpScreennState extends State<DeliverSingUpScreen> {
